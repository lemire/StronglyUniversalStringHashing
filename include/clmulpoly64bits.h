	...
	if (string + 1 < endstring) {
		...
		if (string + 3 < endstring) {
			...
			if (string + 31 < endstring) {
				...
				for (; string + 31 < endstring; string += 32) {
					...
					__m128i temp9 = _mm_lddqu_si128((__m128i *) (string + 16)); //a1 a2
					__m128i temp10 = _mm_lddqu_si128((__m128i *) (string + 18)); //a3 a4
					__m128i temp11 = _mm_lddqu_si128((__m128i *) (string + 20)); //a5 a6
					__m128i temp12 = _mm_lddqu_si128((__m128i *) (string + 22)); //a7 a8
					__m128i temp13 = _mm_lddqu_si128((__m128i *) (string + 24)); //a7 a8
					__m128i temp14 = _mm_lddqu_si128((__m128i *) (string + 26)); //a7 a8
					__m128i temp15 = _mm_lddqu_si128((__m128i *) (string + 28)); //a7 a8
					__m128i temp16 = _mm_lddqu_si128((__m128i *) (string + 30)); //a7 a8
					...
					acc = //precompReduction64_si128
							(
							_mm_xor_si128(tacc, Z1));
					acc = _mm_xor_si128(acc,temp9);
					acc = _mm_xor_si128(acc,temp10);
					acc = _mm_xor_si128(acc,temp11);
					acc = _mm_xor_si128(acc,temp12);
					acc = _mm_xor_si128(acc,temp13);
					acc = _mm_xor_si128(acc,temp14);
					acc = _mm_xor_si128(acc,temp15);
					acc = precompReduction64_si128(acc);
				}
			}
			for (; string + 3 < endstring; string += 4) {
