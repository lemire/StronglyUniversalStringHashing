		...
		if  (string + 3 < endstring) {
			...
			if(string + 7 < endstring){
				...
				for (; string + 7 < endstring; string += 8) {
					...
					const __m128i clprod1 = _mm_clmulepi64_si128(temp4, key, 0x00); //a7*k
					const __m128i clprod2 = _mm_clmulepi64_si128(temp3, key, 0x11); //a6*k^2
					const __m128i clprod3 = _mm_clmulepi64_si128(temp3, key2, 0x00); //a5*k^3
					const __m128i clprod4 = _mm_clmulepi64_si128(temp2, key2, 0x11); //a4*k^4
					const __m128i clprod5 = _mm_clmulepi64_si128(temp2, key3, 0x00); //a3*k^5
					const __m128i clprod6 = _mm_clmulepi64_si128(temp, key3, 0x11); //a2*k^6
					const __m128i clprod7 = _mm_clmulepi64_si128(temp, key4, 0x00); //a1*k^7
					acc = _mm_clmulepi64_si128(acc, key4, 0x10); //k^4
